...
export default function ClientByIdPage() {
      ...
      >
        <div className="space-y-4">
          ...
          <Alert variant="destructive">
            <AlertDescription>
              {clientData?.message ||
                "Client introuvable ou erreur lors du chargement."}
            </AlertDescription>
          </Alert>
        </div>
      </PageLayout>
  ...
  const simulations =
    simulationsData && "simulations" in simulationsData
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 text-sm text-muted-foreground">
                          ...
                          {simulation.result?.savedAt && (
                            <span>{formatDate(simulation.result.savedAt)}</span>
                          )}
                        </div>
                      </div>
                    </div>
